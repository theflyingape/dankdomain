...
RUN dnf -y install gcc-c++ git glibc-common glibc-devel glibc-headers glibc-langpack-en make
RUN dnf -y install openssl python36
...
# Add the code, install dependencies
COPY build ${TARGET}
